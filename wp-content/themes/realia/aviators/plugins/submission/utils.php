...
function aviators_submission_paypal_payment_gateway() {
	...
	if ( $payment_gateway == 'paypal' ) {
		require_once get_template_directory() . "/aviators/libraries/paypal-digital-goods/paypal-digital-goods.class.php";
		require_once get_template_directory() . "/aviators/libraries/paypal-digital-goods/paypal-configuration.class.php";
		require_once get_template_directory() . "/aviators/libraries/paypal-digital-goods/paypal-purchase.class.php";
